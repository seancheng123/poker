...
allCards.set("S2", {code: "S2", value: 2, suit: "Spades"});
allCards.set("S3", {code: "S3", value: 3, suit: "Spades"});
allCards.set("S4", {code: "S4", value: 4, suit: "Spades"});
allCards.set("S5", {code: "S5", value: 5, suit: "Spades"});
allCards.set("S6", {code: "S6", value: 6, suit: "Spades"});
allCards.set("S7", {code: "S7", value: 7, suit: "Spades"});
allCards.set("S8", {code: "S8", value: 8, suit: "Spades"});
allCards.set("S9", {code: "S9", value: 9, suit: "Spades"});
allCards.set("S10", {code: "S10", value: 10, suit: "Spades"});
allCards.set("SJ", {code: "SJ", value: 11, suit: "Spades"});
allCards.set("SQ", {code: "SQ", value: 12, suit: "Spades"});
allCards.set("SK", {code: "SK", value: 13, suit: "Spades"});
allCards.set("SA", {code: "SA", value: 14, suit: "Spades"});

//allCards.set("C1", {code: "C1", value: 1, suit: "Clubs"});
allCards.set("C2", {code: "C2", value: 2, suit: "Clubs"});
allCards.set("C3", {code: "C3", value: 3, suit: "Clubs"});
allCards.set("C4", {code: "C4", value: 4, suit: "Clubs"});
allCards.set("C5", {code: "C5", value: 5, suit: "Clubs"});
allCards.set("C6", {code: "C6", value: 6, suit: "Clubs"});
allCards.set("C7", {code: "C7", value: 7, suit: "Clubs"});
allCards.set("C8", {code: "C8", value: 8, suit: "Clubs"});
allCards.set("C9", {code: "C9", value: 9, suit: "Clubs"});
allCards.set("C10", {code: "C10", value: 10, suit: "Clubs"});
allCards.set("CJ", {code: "CJ", value: 11, suit: "Clubs"});
allCards.set("CQ", {code: "CQ", value: 12, suit: "Clubs"});
allCards.set("CK", {code: "CK", value: 13, suit: "Clubs"});
allCards.set("CA", {code: "CA", value: 14, suit: "Clubs"});

//allCards.set("H1", {code: "H1", value: 1, suit: "Hearts"});
allCards.set("H2", {code: "H2", value: 2, suit: "Hearts"});
allCards.set("H3", {code: "H3", value: 3, suit: "Hearts"});
allCards.set("H4", {code: "H4", value: 4, suit: "Hearts"});
allCards.set("H5", {code: "H5", value: 5, suit: "Hearts"});
allCards.set("H6", {code: "H6", value: 6, suit: "Hearts"});
allCards.set("H7", {code: "H7", value: 7, suit: "Hearts"});
allCards.set("H8", {code: "H8", value: 8, suit: "Hearts"});
allCards.set("H9", {code: "H9", value: 9, suit: "Hearts"});
allCards.set("H10", {code: "H10", value: 10, suit: "Hearts"});
allCards.set("HJ", {code: "HJ", value: 11, suit: "Hearts"});
allCards.set("HQ", {code: "HQ", value: 12, suit: "Hearts"});
allCards.set("HK", {code: "HK", value: 13, suit: "Hearts"});
allCards.set("HA", {code: "HA", value: 14, suit: "Hearts"});

//allCards.set("D1", {code: "D1", value: 1, suit: "Diamonds"});
allCards.set("D2", {code: "D2", value: 2, suit: "Diamonds"});
allCards.set("D3", {code: "D3", value: 3, suit: "Diamonds"});
allCards.set("D4", {code: "D4", value: 4, suit: "Diamonds"});
allCards.set("D5", {code: "D5", value: 5, suit: "Diamonds"});
allCards.set("D6", {code: "D6", value: 6, suit: "Diamonds"});
allCards.set("D7", {code: "D7", value: 7, suit: "Diamonds"});
allCards.set("D8", {code: "D8", value: 8, suit: "Diamonds"});
allCards.set("D9", {code: "D9", value: 9, suit: "Diamonds"});
allCards.set("D10", {code: "D10", value: 10, suit: "Diamonds"});
allCards.set("DJ", {code: "DJ", value: 11, suit: "Diamonds"});
allCards.set("DQ", {code: "DQ", value: 12, suit: "Diamonds"});
allCards.set("DK", {code: "DK", value: 13, suit: "Diamonds"});
allCards.set("DA", {code: "DA", value: 14, suit: "Diamonds"});
...
function simulate(players, combos) {
    if (players.length <= 0) {
        // ???
        return undefined;
    }
    ...
    for (let i = 0; i < combos.length; i++) {
        if (!(ignored(ignoreCards, combos[i]))) {
            for (let j = 0; j < players.length; j++) {
                temp = players[j].cards.slice();
                for (let k = 0; k < combos[i].length; k++) {
                    mergeHand(temp, allCards.get(combos[i][k]));
                }
                
                players[j].bestHand = calcBestHand(temp);
                
            }
            //console.log(combos[i]);
            checkWin(players);
            //console.log("ABABABABABAABBABABAABABABABABAABBABABAABABABABABAABBABABAABABABABABAABBABABA");
            runs++;
        }
    }

    // Compute the win percentages for each player
    for (let i = 0; i < players.length; i++) {
...
function mergeHand(cards, newCard) {
...
let con = mysql.createConnection({
    host: "localhost",
    user: "root",
    password: "giantpanda168",
    database: "poker_combinations"
});
let num = 0;
let q;
con.connect(function(err) {
    ...
    q = "SELECT val1,val2,val3,val4,val5 FROM five_cards WHERE NOT (val1 = 'SK' OR val2 = 'SK' OR val3 = 'SK' OR val4 = 'SK' OR val5 = 'SK')";
